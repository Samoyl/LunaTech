...
public class Runways {
	...
	public String getLe_heading_deg() {
		return le_heading_deg;
	}

	public void setLe_heading_deg(String le_heading_deg) {
		this.le_heading_deg = le_heading_deg;
	}
